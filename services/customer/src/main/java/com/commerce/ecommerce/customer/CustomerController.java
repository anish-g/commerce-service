...
public class CustomerController {
    ...
    @GetMapping
    public ResponseEntity<List<com.alibou.ecommerce.customer.CustomerResponse>> findAll() {
    ...
    public ResponseEntity<com.alibou.ecommerce.customer.CustomerResponse> findById(
            @PathVariable("customer-id") String customerId
    ) {
